        ...
        <Grid item xs={12} sm={10} className={classes.footerRight}>
          <Grid container style={{ height: '100%' }}>
            ...
            <Grid item xs={12} sm={3} className={classes.footerRightContent}>
              ...
              <Button className={classnames(classes.button, 'fab fa-google-play fa-2x')} />
            </Grid>
            <Grid item xs={12} sm={3} className={classes.footerRightContent}>
              <Button variant='contained' color='primary'>
								Follow Us
              </Button>
              <Button className={classnames(classes.button, 'fab fa-facebook fa-2x')} />
              <Button className={classnames(classes.button, 'fab fa-instagram fa-2x')} />
            </Grid>
            <Grid item xs={12} sm={3} className={classes.footerRightContent}>
